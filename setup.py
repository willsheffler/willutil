...
setup(
    ...
    package_data={
        'willutil': [
            ...
            'data/spacegroup_data.pickle.xz',
            'data/pseudo_t/T2_3iz3.npy',
            'data/pseudo_t/T3_2tbv.npy',
            'data/pseudo_t/T4_1ohf_A510.npy',
            'data/pseudo_t/T7_1ohg_A200.npy',
            'data/pseudo_t/T9_8h89_J155.npy',
            'data/pseudo_t/T13_2btv.npy'
