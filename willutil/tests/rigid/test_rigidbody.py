...
def test_rigidbody_cellsize_scale(showme=False):
    ...
    coms0 = np.array(
        [
            [1.67999986e01, 9.69947657e00, 2.95419880e01],
            [-1.67999924e01, 9.69948730e00, 2.95419880e01],
            [-6.19596624e-06, -1.93989639e01, 2.95419880e01],
            [6.32000014e01, -9.69947657e00, 2.95419880e01],
            [8.00000062e01, 1.93989639e01, 2.95419880e01],
            [1.03200008e02, 7.89815196e01, 2.95419880e01],
            [-5.67999986e01, -7.89815089e01, 2.95419880e01],
            [-1.03200001e02, 7.89815089e01, 2.95419880e01],
            [-1.20000006e02, -8.86809962e01, 2.95419880e01],
            [1.03200008e02, -5.95825450e01, 2.95419880e01],
            [-2.32000076e01, -7.89815196e01, 2.95419880e01],
            [-1.20000006e02, 4.98830684e01, 2.95419880e01],
            [-1.03200001e02, -5.95825557e01, 2.95419880e01],
            [-5.67999986e01, 5.95825557e01, 2.95419880e01],
            [-3.99999938e01, -4.98830684e01, 2.95419880e01],
            [9.67999924e01, -9.69948730e00, 2.95419880e01],
            [-2.32000076e01, 5.95825450e01, 2.95419880e01],
            [-3.99999938e01, 8.86809962e01, 2.95419880e01],
        ]
    )
    ...
    coms1 = np.array(
        [
            ...
            [-1.67999924e01, 9.69948730e00, 2.95419880e01],
            [-6.19596624e-06, -1.93989639e01, 2.95419880e01],
            [7.92000014e01, -9.69947657e00, 2.95419880e01],
            [9.60000062e01, 1.93989639e01, 2.95419880e01],
            [1.27200008e02, 9.28379261e01, 2.95419880e01],
            [-6.47999986e01, -9.28379153e01, 2.95419880e01],
            [-1.27200001e02, 9.28379153e01, 2.95419880e01],
            [-1.44000006e02, -1.02537403e02, 2.95419880e01],
            [1.27200008e02, -7.34389515e01, 2.95419880e01],
            [-3.12000076e01, -9.28379261e01, 2.95419880e01],
            [-1.44000006e02, 6.37394749e01, 2.95419880e01],
            [-1.27200001e02, -7.34389622e01, 2.95419880e01],
            [-6.47999986e01, 7.34389622e01, 2.95419880e01],
            [-4.79999938e01, -6.37394749e01, 2.95419880e01],
            [1.12799992e02, -9.69948730e00, 2.95419880e01],
            [-3.12000076e01, 7.34389515e01, 2.95419880e01],
            [-4.79999938e01, 1.02537403e02, 2.95419880e01],
        ]
    )
    # print(repr(body.coms()[:, :3]))
    if showme:
