...
def test_symelems_R3(debug=False, **kw):
   val = dict(
      ...
      C31=[
         SymElem(3, axis=[0, 0, 1], cen=[0.0, 0.666666666, 0.0], hel=0.333333333, label='C31'),
      ],
      C32=[
...
def test_symelems_P213(debug=False, **kw):
   ...
   val = dict(
      ...
      C32=[
         SymElem(3, axis=[1, 1, 1], cen=[0.666666667, 0.0, 0.333333333], hel=1.154700538, label='C32'),
      ],
   )
...
def test_symelems_P41212(debug=False, **kw):
   val = dict(
      ...
      C41=[
         SymElem(4, axis=[0, 0, 1], cen=[0.0, 0.5, 0.0], hel=-1.75, label='C41'),
      ],
   )
