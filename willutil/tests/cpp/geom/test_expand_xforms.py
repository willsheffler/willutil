...
def expand_xforms_rand(
   ...
   for i, x in enumerate(unique_key_frames):
      dist, ang = wu.cpp.geom.xform_dist2_split(x, unique_key_frames, 1.0)
      # print(i, dist, ang)
...
def test_expand_xforms_various_count_cpp(trials=3):
   _test_expand_xforms_various_count(wu.cpp.geom.expand_xforms_rand, trials)
...
def do_test_expand_xforms(
   ...
   for _ in range(trials):
      ...
      c, o = wu.cpp.geom.xform_dist2_split(x, ex, 1.0)
