__all__ = ('MonteCarlo', 'RigidBody', 'compute_symfit', 'showme', 'halign', 'halign2', 'halign_vector', 'hangle',
           ...
           'hframe', 'hparallel', 'hpow', 'hproj', 'hprojperp', 'hrand', 'hrandpoint', 'hrandrot', 'hray', 'hrmsfit',
           'hrog', 'hrog_flat', 'hrot', 'hscaled', 'htrans', 'hvalid', 'hvec', 'hxaxis_of', 'hxform', 'hyaxis_of',
           'hzaxis_of', 'line_angle', 'line_angle_degrees', 'rot_of', 't_rot', 'th_angle', 'th_axis', 'th_axis_angle',
