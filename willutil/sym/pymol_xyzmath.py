...
class Mat(object):
    ...
    def det(m):
        ...
        # a31(  a23  a12- a22  a13)
        return (
            m.xx * (m.zz * m.yy - m.zy * m.yz)
            - m.yx * (m.zz * m.xy - m.zy * m.xz)
            + m.zx * (m.yz * m.xy - m.yy * m.xz)
        )
    ...
    def __eq__(self, other):
        return (
            abs(self.xx - other.xx) < EPS
            and abs(self.xy - other.xy) < EPS
            and abs(self.xz - other.xz) < EPS
            and abs(self.yx - other.yx) < EPS
            and abs(self.yy - other.yy) < EPS
            and abs(self.yz - other.yz) < EPS
            and abs(self.zx - other.zx) < EPS
            and abs(self.zy - other.zy) < EPS
