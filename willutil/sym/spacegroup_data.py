...
def _get_spacegroup_data():
   ...
   if have_package_data('spacegroup_data'):
      ...
      sg_orthorhombic = 'P222 P2221 P212S12 P212121 C2221 C222 F222 I222 I212121 Pmm2 Pmc21 Pcc2 Pma2 Pca21 Pnc2 Pmn21 Pba2 Pna21 Pnn2 Cmm2 Cmc21 Ccc2 Amm2 Abm2 Ama2 Aba2 Fmm2 Fdd2 Imm2 Iba2 Ima2 Pmmm Pnnn:2 Pccm Pban:2 Pmma Pnna Pmna Pcca Pbam Pccn Pbcm Pnnm Pmmn:2 Pbcn Pbca Pnma Cmcm Cmca Cmmm Cccm Cmma Ccca:2 Fmmm Fddd:2 Immm Ibam Ibca Imma'.split()
      ...
      for k, v in sg_tag.items():
         tmp, _sg_cheshire[k] = getattr(spacegroup_frames, f'symframes_{v}')()
