...
class Xtal:
   ...
   def primary_frames(self, cellsize=1):
      'frames generated by the primary sym elems'
      frames = [np.eye(4)]
      # ic(self.symelems)
      for s in self.symelems:
         frames += list(s.operators[1:])
   ...
   def asucen(
      ...
      **kw,
      ...
      if method == 'closest_to_cen':
         ...
         raise ValueError(f'unknown asucen method {method}')
      if use_olig_nbrs:
   ...
   def symcoords(self, asymcoords, cellsize, cells=1, flat=False, center=None, **kw):
      if center is None:
      ...
      if cells == 0:
         ...
         frames = self.cellframes(cellsize, cells, center=center, **kw)
