...
class Helix:
    ...
    def frames(
        self, radius, spacing, coils=1, xtalrad=9e9, start=None, closest=0, closest_upper_only=False, **kw
    ):
        ...
        for icyc in range(self.nfold):
            ...
            frames += [
                xcyc @ wu.hrot(axis, i * ang, hel=i * spacing / self.turns, degrees=False)
