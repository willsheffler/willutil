...
def pseudo_t_start(t):
   ...
   # wu.showme(asu, weight=20, xyzlen=[20, 14, 8])
   # wu.showme(wu.sym.make('I', asu), weight=10, xyzlen=[10, 7, 4])
   # wu.showme(hcart(frames), sphere=10)
